using DependencyInjectionPOC.Models;
...
namespace DependencyInjectionPOC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, ISingleton singleton, ITransient transient, IScoped scoped, GuidService guidService)
        {
            _logger = logger;
